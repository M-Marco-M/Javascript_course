...
console.log(
  "My country have more population than Finland: " + myCountryHaveMorePeople
);

let avgGlobalPopulation = 33;
myCountryHaveMorePeople = population > avgGlobalPopulation;
console.log(
  "My country have more population than average of countries: " +
    myCountryHaveMorePeople
);
...
if (population > avgGlobalPopulation) {
  console.log(
    `${country}'s population is ${
      population - avgGlobalPopulation
    } million over average`
  );
} else {
  console.log(
    `${country}'s population is ${
      avgGlobalPopulation - population
